...
import { loginSupplier, registerSupplier, logoutSupplier, getSupplierProfile, getSubscriptions, getCustomers } from "../controllers/supplier.controller.js";
...
router.route('/get-customers').get(verifySupplier, getCustomers)
